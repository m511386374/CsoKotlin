...
class GuidePagePresenter
@Inject
constructor(model: GuidePageContract.Model, rootView: GuidePageContract.View) :
        BasePresenter<GuidePageContract.Model, GuidePageContract.View>(model, rootView) {
    @Inject
