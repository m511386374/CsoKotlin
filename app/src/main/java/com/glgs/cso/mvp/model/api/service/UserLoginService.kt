...
interface UserLoginService {
    @FormUrlEncoded
    @POST(NetMethodApi.NET_METHOD_USER_LOGIN)
    fun getLoginDate(@FieldMap map: HashMap<String, Any>):Observable<BaseResponse<LoginBean>>

    @FormUrlEncoded
    @POST(NetMethodApi.NET_METHOD_APP_JSON)
    fun getAppJson(@FieldMap map: HashMap<String, Any>):Observable<BaseResponse<AppBean>>
}
