 ...
 * 描    述：
 */
interface ResetNewPasswordService {

    @FormUrlEncoded
    @POST(NetMethodApi.NET_METHOD_EDITPASSWORD)
    fun updatePassword(@FieldMap map: Map<String, Any>): Observable<BaseResponse<CommonBean>>
}
