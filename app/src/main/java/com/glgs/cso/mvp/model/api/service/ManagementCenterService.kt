 ...
 * 描    述：
 */
interface ManagementCenterService {

    @FormUrlEncoded
    @POST(NetMethodApi.NET_METHOD_GETBANNER)
    fun getBanner(@FieldMap map: Map<String, Any>): Observable<BaseResponse<List<ManagementCenterBannerBean>>>
