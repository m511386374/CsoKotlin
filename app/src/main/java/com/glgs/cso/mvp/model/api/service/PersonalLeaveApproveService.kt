 ...
 * 描    述：
 */
interface PersonalLeaveApproveService {
    @FormUrlEncoded
    @POST(NetMethodApi.NET_METHOD_NEWBUILDPERSONALLEAVEAPPROVE)
    fun newPersonalLeaveApprove(@FieldMap map: Map<String, Any>): Observable<BaseResponse<CommonBean>>
