 ...
 * 描    述：
 */
interface NewBuildCommonApproveService {
    @FormUrlEncoded
    @POST(NetMethodApi.NET_METHOD_NEWBUILDCOMMONAPPROVE)
    fun newBuildCommonApprove(@FieldMap map: Map<String, Any>): Observable<BaseResponse<CommonBean>>
