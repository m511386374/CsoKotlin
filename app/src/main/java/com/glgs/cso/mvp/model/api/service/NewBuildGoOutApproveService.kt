 ...
 * 描    述：
 */
interface NewBuildGoOutApproveService {
    @FormUrlEncoded
    @POST(NetMethodApi.NET_METHOD_NEWBUILDGOOUTAPPROVE)
    fun newBuildGoOutApprove(@FieldMap map: Map<String, Any>): Observable<BaseResponse<CommonBean>>
