 ...
 * 描    述：
 */
interface NewBuildTripApproveService {
    @FormUrlEncoded
    @POST(NetMethodApi.NET_METHOD_NEWBUILDTRIPAPPROVE)
    fun newBuildTripApproveApprove(@FieldMap map: Map<String, Any>): Observable<BaseResponse<CommonBean>>
