...
import com.glgs.cso.di.component.DaggerMyComponent
import com.glgs.cso.di.module.MyModule
import com.glgs.cso.mvp.contract.MyContract
import com.glgs.cso.mvp.presenter.MyPresenter
 ...
 * }
 */
class MyFragment : BaseUiFragment<MyPresenter>(), MyContract.View {
    override fun getMySuccess(commonBean: CommonBean) {
